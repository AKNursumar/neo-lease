...
const recentActivities = [
  ...
  },
  {
    id: 4,
    type: "payment",
    message: "Payment received: $450 from Sarah Wilson",
    time: "2 hours ago",
    status: "success"
  },
  {
...
const topProducts = [
  { name: "Professional Camera Kit", rentals: 45, revenue: "$3,825" },
  { name: "MacBook Pro", rentals: 38, revenue: "$5,700" },
  { name: "DJ Mixer", rentals: 32, revenue: "$3,040" },
  { name: "Power Drill Set", rentals: 28, revenue: "$700" },
  { name: "Gaming Laptop", rentals: 25, revenue: "$3,000" }
];
